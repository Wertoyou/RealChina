...
\subsection*{USA}
USA är ett exempel på ett land som har ett Taipeiskt representationskontor. USA har traditionellt sätt alltid haft goda relationer med ROC. 

\subsection*{Europa}

\section*{Framtid}
Eftersom huvudpartiet i den Pan-gröna koalitionen har ensam absolut majoritet i Taiwans parlament från och med den 20 maj 2016 så ser den nära framtiden möjligt turbulent ut i den här konflikten. Eftersom senast som den Pan-gröna koalitionen styrde så byggde PRC upp en stor armada av missiler på andra sidan Taiwansundet. Det kommer med absolut största sannolikhet innebära att det blir någon form av upprustning i området. 

\section*{Källor}
\href{https://www.landguiden.se/Lander/Asien/Taiwan}{Landguiden}\\
